...
# <script>
#     new EmbedLiteSDK({
#         appId: '3e32fc42-53b6-495d-a739-38b13c50ca6a',
#         code: 'embed3dx7ftgTSl8cQNPH6DsF'
#     });
# </script>
# """
# # 嵌入到 Streamlit 中
# st.components.v1.html(chatbar_code, height=500)

# # 使用 HTML + CSS 创建固定位置的聊天框
# chat_html = """
# <div style="
#     position: fixed;
#     bottom: 10px;
...
#     padding: 10px;
# ">
#     <div style="height: 350px; overflow-y: auto;" id="chat-box">
#         <p><b>系统:</b> 欢迎来到聊天框！</p>
#     </div>
